...
Viewing the source on the page indicates that Jekyll rendered it correctly to an H1 tag, so it is probably in the CSS. Investigate at earliest convenience. 
